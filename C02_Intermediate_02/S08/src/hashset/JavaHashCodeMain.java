...
public class JavaHashCodeMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(member1 == member2) = " + (member1 == member2)); // 실제 메모리 위치는 다름
        System.out.println("(member1.equals(member2) = " + (member1.equals(member2))); // id가 같으면 같은 객체로 판단하도록 오버라이딩 해둠
